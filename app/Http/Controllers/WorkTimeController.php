...
class WorkTimeController extends Controller {
    public function index() {
        ...
        return view( 'doctor.work-time', compact( 'dbWorkTime' ) );
    }
    public function edit_worktime($WorktimeID){
        ...
        return view( 'doctor.update-work-time',compact('dbWorkTime','dayOfWeek'));
    }
    ...
    public function add_workTime(){
        $dayOfWeek = ['Thứ 2', 'Thứ 3', 'Thứ 4', 'Thứ 5', 'Thứ 6', 'Thứ 7', 'CN'];
        return view( 'doctor.add-work-time',compact('dayOfWeek'));
    }
