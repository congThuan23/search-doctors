...
<nav class="navbar navbar-expand-lg">
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		...
		<li class="nav-item dropdown ms-auto" style="list-style:none; margin-right: 120px">
			...
			<li>
				<a class="dropdown-item" href="#">Trình độ năng lực</a>
			</li>
			<li>
				...
				<div class="find-a-doctoc__doctor-list">
					<div class="row huma">
						...
						<div class="col-md-8" >
							...
							<form action="{{URL::to('/worktime/update/'.$item->WorkTimeID)}}" method="POST">
								@csrf   
								<div class="row" style="display:flex ;">
									<div class="col-md-6">
										<label for=""><strong>Thứ</strong></label>
							...
							<div class="col-md-6">
								<label for=""><strong>Địa điểm làm việc</strong></label>
								<div class="btn-group" style="width: 100%">
							...
							<div class="col-md-6">
								...
								<div class="btn-group" style="width: 100%">
									<input type="time" id="contact-info-vertical"
									class="form-control"
									name="Finish" value="{{$item->Finish}}">
								</div>
							</div>
						</div>
						<div class="row">
